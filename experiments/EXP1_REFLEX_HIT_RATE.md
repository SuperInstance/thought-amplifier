...
**VERDICT (TF-IDF):** The 40% threshold is NOT achievable with TF-IDF embeddings.
...
|--------|--------------------|-----------------|-------|
| Mean pairwise similarity | ~0.05-0.15 (typical) | **0.6097** | ~4-8× higher |
| Max pairwise similarity | ~0.30-0.50 (typical) | **0.8092** | ~2× higher |
| Pairs ≥0.55 | Low | **52/56 (93%)** | — |
| Pairs ≥0.80 | ~0 | **2/56 (4%)** | — |

### Nomic Pairwise Similarity Matrix (8 cognitive thoughts)

| | T0 | T3 | T4 | T5 | T6 | T7 | T8 | T10 |
|---|---|---|---|---|---|---|---|---|
| T0 | 1.000 | 0.596 | 0.606 | 0.632 | 0.540 | 0.596 | 0.605 | 0.631 |
| T3 | 0.596 | 1.000 | 0.672 | 0.718 | 0.618 | 0.619 | 0.607 | 0.809 |
| T4 | 0.606 | 0.672 | 1.000 | 0.587 | 0.579 | 0.562 | 0.580 | 0.700 |
| T5 | 0.632 | 0.718 | 0.587 | 1.000 | 0.574 | 0.572 | 0.534 | 0.632 |
| T6 | 0.540 | 0.618 | 0.579 | 0.574 | 1.000 | 0.633 | 0.557 | 0.573 |
| T7 | 0.596 | 0.619 | 0.562 | 0.572 | 0.633 | 1.000 | 0.594 | 0.583 |
| T8 | 0.605 | 0.607 | 0.580 | 0.534 | 0.557 | 0.594 | 1.000 | 0.560 |
| T10 | 0.631 | 0.809 | 0.700 | 0.632 | 0.573 | 0.583 | 0.560 | 1.000 |

### Sample Thoughts Used

| Index | Thought (first 60 chars) |
|-------|--------------------------|
| T0 | "I pause at this storm on island where colors shift and chang..." |
| T3 | "Looking around the forest path, something glints just below ..." |
| T4 | "Looking around the desert canyon, fragrant blooms release th..." |
| T5 | "The harbor at dusk is striking — something glints just below..." |
| T6 | "The sandstone arch is striking — distant lights flicker and ..." |
| T7 | "What catches my eye at the crystal cave: ancient markings co..." |
| T8 | "What catches my eye at the obsidian field: the terrain chang..." |
| T10 | "I pause at this bamboo grove where water flows from an unsee..." |

### Interpretation

The neural embeddings reveal that cognitive thoughts share **deep semantic similarity**
(mean cosine = 0.610) that TF-IDF completely misses. This is because:
...
If the neural embedding pattern (mean similarity ~0.61) holds across the full
